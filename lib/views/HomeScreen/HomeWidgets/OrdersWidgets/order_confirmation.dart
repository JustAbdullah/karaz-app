                ...
                children: [
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Visibility(
                          visible:
                              controllerApp.whereIsTheOrderStyp.value == 3 ||
                                  controllerApp.whereIsTheOrderStyp.value == 4,
                          child: InkWell(
                            onTap: () {
                              if (controllerApp.whereIsTheOrderStyp.value ==
                                  3) {
                                controllerApp.OpeartionsOrderPage.value = false;
                                controllerApp.countTheTimeChosed.value = 0;
                                controllerApp.countTheWhatChooseOfDate.value =
                                    0;
                  ...
                  Visibility(
                    visible: controllerApp.whereIsTheOrderStyp.value == 3 ||
                        controllerApp.whereIsTheOrderStyp.value == 4,
                    child: Padding(
                                ...
                                child: Directionality(
                                  ...
                                  child: Row(
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          controllerApp.countTheWhatChooseOfDate
                                              .value = 1;
                                  ...
                                  child: Padding(
                                      ...
                                      child: Directionality(
                                          ...
                                          child: Row(children: [
                                            InkWell(
                                              onTap: () {
                                                controllerApp.countTheTimeChosed
                                                    .value = 1;
                                                controllerApp
                                                        .theTimeChosed.value =
                      ...
                      child: Container(
                        ...
                        child: FutureBuilder(
                            future: controllerApp.getSubOfOrders(
                                controller.theNumberOFORder.value.toString()),
                            builder:
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              controller.totalPriceTheSerivce.value.toString(),
                              style: TextStyle(
                                fontFamily: AppTextStyles.Almarai,
                                color: AppColors.balckColorTypeThree,
                                fontSize: 14.sp,
                        ...
                        child: Row(
                          children: [
                            Directionality(
                              textDirection: TextDirection.ltr,
                              child: Text(
                                controllerApp.theDateChoosd.value.toString(),
                                style: TextStyle(
                                  fontFamily: AppTextStyles.Almarai,
                                  color: AppColors.balckColorTypeThree,
                                  fontSize: 14.sp,
                        ...
                        child: Row(
                          children: [
                            Directionality(
                              textDirection: TextDirection.ltr,
                              child: Text(
                                controllerApp.theTimeChosed.value.toString(),
                                style: TextStyle(
                                  fontFamily: AppTextStyles.Almarai,
                                  color: AppColors.balckColorTypeThree,
                                  fontSize: 14.sp,
                      ...
                      builder: (controller) => Visibility(
                          ...
                          child: Align(
                            ...
                            child: Lottie.asset(ImagesPath.successfully,
                                repeat: false, width: 150.w, height: 120.h),
                          ))),
                  GetX<ControllerApp>(
                      builder: (controller) => Visibility(
                          visible: controller.showTheEndOfPageOrder.value,
                              ...
                              child: Padding(
                                  ...
                                  child: Directionality(
                                      ...
                                      child: Row(children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            controllerApp.showTheEndOfPageOrder
                                                .value = false;
                                            controllerApp.OpeartionsOrderPage
                                                .value = false;
                                            controller
                                                .showTheDetialsAboutTheService
                                                .value = false;
                                            controller.showTheSubTypeOFService
                                                .value = false;
                                            controllerApp.clearOrder();
                                            controllerApp.clearTheDataOrder();
